      ...
      <section className="py-16 bg-white">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            <h2 className="text-3xl font-bold text-green-900 mb-8 text-center">Notre Histoire</h2>
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
              ...
              <div className="bg-green-50 rounded-xl p-8">
                <h3 className="text-2xl font-bold text-green-900 mb-4">Chiffres Clés</h3>
                <div className="space-y-3">
                  <div className="flex justify-between">
                    <span className="text-green-700">Année de création</span>
                    <span className="font-bold text-green-900">2002</span>
                  </div>
                  <div className="flex justify-between">
                    <span className="text-green-700">Participants totaux</span>
                    <span className="font-bold text-green-900">5000+</span>
                  </div>
                  <div className="flex justify-between">
                    <span className="text-green-700">Partenaires</span>
                    <span className="font-bold text-green-900">85+</span>
                  </div>
                  <div className="flex justify-between">
                    <span className="text-green-700">Événements organisés</span>
                    <span className="font-bold text-green-900">127+</span>
                  </div>
                </div>
              </div>
            </div>
      ...
      <section className="py-16 bg-green-50">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center">
            <h2 className="text-3xl font-bold text-green-900 mb-8">Notre Mission</h2>
            <p className="text-xl text-green-700/80 mb-12">
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              <div className="bg-white rounded-xl p-6">
                <h3 className="text-xl font-bold text-green-900 mb-3">Excellence</h3>
                <p className="text-green-700/80">
                  Promouvoir l'excellence académique et professionnelle
                </p>
              </div>
              <div className="bg-white rounded-xl p-6">
                <h3 className="text-xl font-bold text-green-900 mb-3">Innovation</h3>
                <p className="text-green-700/80">
                  Encourager l'innovation et l'entrepreneuriat
                </p>
              </div>
              <div className="bg-white rounded-xl p-6">
                <h3 className="text-xl font-bold text-green-900 mb-3">Leadership</h3>
                <p className="text-green-700/80">
