              ...
              <div className="bg-emerald-50 rounded-xl p-8">
                ...
                <div className="space-y-3">
                  <div className="flex justify-between">
                    <span className="text-emerald-700">Année de création</span>
                    <span className="font-bold text-emerald-900">2002</span>
                  </div>
                  <div className="flex justify-between">
                    <span className="text-emerald-700">Participants totaux</span>
                    <span className="font-bold text-emerald-900">5000+</span>
                  </div>
                  <div className="flex justify-between">
                    <span className="text-emerald-700">Partenaires</span>
                    <span className="font-bold text-emerald-900">85+</span>
                  </div>
                  <div className="flex justify-between">
                    <span className="text-emerald-700">Événements organisés</span>
      ...
      <section className="py-16 bg-emerald-50">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <p className="text-xl text-emerald-700/80 mb-12">
