    ...
    >
      ...
      <div className="container mx-auto px-4 relative z-10">
        <div className="text-center mb-20">
          ...
          <h1 className="text-4xl md:text-5xl font-extrabold text-transparent bg-clip-text bg-gradient-to-r from-emerald-600 via-black to-emerald-400 mb-4">
            ...
            filteredEvents.map((event, index) => (
              ...
              >
                ...
                <div className="flex flex-col gap-3 md:items-end mt-4 md:mt-0 w-full md:w-auto">
                  <button className="w-full md:w-auto px-8 py-3 bg-gradient-to-r from-emerald-500 to-black text-white rounded-3xl font-semibold shadow-lg hover:scale-105 hover:shadow-emerald-400/30 transition flex items-center justify-center gap-2 text-base md:text-lg">
