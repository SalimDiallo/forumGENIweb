...
export default function CreateEventForm({}: CreateEventFormProps) {
  ...
  // ---------- SIMPLIFIED GLOBAL ERROR DISPLAY BELOW THE FORM ----------
  // Gather and flatten all error messages
  ...
  return (
    <form onSubmit={handleSubmit(onSubmit)}>
      <div className="space-y-4">
        ...
        {/* Error Messages - simplified global display below */}
        {(allErrorMessages.length > 0 || createEventMutation.error) && (
          <div className="mt-4">
                ...
                {createEventMutation.error && (
                  <>
                    ...
                    {typeof createEventMutation.error === "object" &&
                      ...
                      <div className="text-red-700 text-xs italic">{(createEventMutation.error as Error).message}</div>
                    }
                  </>
                )}
              </div>
