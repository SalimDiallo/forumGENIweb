...
type EditEventFormProps = { event: Event };
...
export default function EditEventForm({ event }: EditEventFormProps) {
  ...
  const form = useForm({
    ...
    validationSchema: updateEventSchema as any,
    validateOnChange: true,
    customValidation: (values) => {
      const errors: Record<string, any> = {};
      // Restrict editors to draft only
  ...
  // Slug management (auto and custom modes)
  const slug = useSlug({
  ...
  const editMutation = useMutation({
    mutationFn: async (data: typeof form.values) => {
      const result = await doEditEvent(data as any);
              ...
              <div className="grid grid-cols-2 gap-4">
                ...
                <div>
                  ...
                  <Select
                    ...
                    onChange={(e) =>
                      form.setFieldValue("eventType", e.target.value as EventType)
                    }
                ...
                <div>
                  ...
                  <Select
                    ...
                    disabled={isEditor}
                    onChange={(e) =>
                      form.setFieldValue("status", e.target.value as EventStatus)
                    }
                ...
                <div className="col-span-2">
                  ...
                  <MarkdownEditor
                    ...
                    placeholder="Description détaillée de l'événement (Markdown accepté)"
                  />
              ...
              <div className="grid grid-cols-2 gap-4">
                ...
                <div>
                  ...
                  <Select
                    ...
                    onChange={(e) =>
                      form.setFieldValue("isVirtual", selectValueToBoolean(e.target.value))
                    }
                  >
                ...
                <div>
                  ...
                  <Select
                    ...
                    onChange={(e) =>
                      form.setFieldValue("isFeatured", selectValueToBoolean(e.target.value))
                    }
                  >
                    <option value="true">Oui</option>
                    <option value="false">Non</option>
                ...
                <div className="col-span-2">
                  ...
                  <MarkdownEditor
                    ...
                    placeholder="Programme de l'événement (Markdown accepté, facultatif)"
                  />
              ...
              <div className="grid grid-cols-2 gap-4">
                ...
                <div>
                  ...
                  <Input
                    ...
                    onChange={(e) =>
                      form.setFieldValue("registrationStart", e.target.value)
                    }
                ...
                <div>
                  ...
                  <Input
                    ...
                    onChange={(e) =>
                      form.setFieldValue("registrationEnd", e.target.value)
                    }
                ...
                <div>
                  ...
                  <Select
                    ...
                    onChange={(e) =>
                      form.setFieldValue("isFree", selectValueToBoolean(e.target.value))
                    }
                  >
                    <option value="true">Oui</option>
                    <option value="false">Non</option>
                ...
                <div>
                  ...
                  <Input
                    ...
                    onChange={(e) =>
                      form.setFieldValue("price", e.target.value === "" ? 0 : Number(e.target.value))
                    }
                ...
                <div className="col-span-2">
                  <label className="block font-medium mb-1">
                    Lien de visioconférence (si virtuel)
                  </label>
                  <Input
                ...
                <div className="col-span-2">
                  ...
                  <MarkdownEditor
                    ...
                    placeholder="Prérequis pour participer (Markdown accepté, facultatif)"
                  />
