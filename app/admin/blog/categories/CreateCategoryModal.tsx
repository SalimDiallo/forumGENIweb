...
export default function CreateCategoryModal({ open, onClose, onSuccess }: CreateCategoryModalProps) {
    ...
    return (
        <Modal open={open} title="Créer une catégorie" onClose={handleClose}>
            <form onSubmit={handleSubmit} noValidate className="space-y-4">
                ...
                <div>
                    ...
                    <textarea
                        ...
                        rows={2}
                        className={`w-full border rounded-lg px-4 py-2.5 focus:ring-2 focus:ring-emerald-500 ${form.hasError("description") ? "border-red-300" : "border-gray-300"
                            }`}
                    />
                ...
                <div className="grid grid-cols-2 gap-4">
                    ...
                    <div>
                        ...
                        <Select
                            value={booleanToSelectValue(form.values.isActive)}
                            onChange={(e) => form.setFieldValue("isActive", selectValueToBoolean(e.target.value))}
                        >
