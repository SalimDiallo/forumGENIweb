...
import { ProtectedAction, ReadOnlyMessage } from "@/components/admin/ProtectedAction";
...
export default function UsersManagementPage() {
  ...
  return (
    <RouteGuard minRole="super_admin">
      <div className="space-y-6">
        ...
        <ReadOnlyMessage message="Vous consultez la liste des utilisateurs en lecture seule. Seuls les Super Admins peuvent gérer les utilisateurs." />
